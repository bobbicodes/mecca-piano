...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$transform,["translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1((0.3 + ((24) * (n - (1))))),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(6.3),")"].join(''),cljs.core.cst$kw$d,(function (){var G__20165 = n;
switch (G__20165) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20165)].join('')));
...
mecca.notation.drum_hit = (function mecca$notation$drum_hit(duration,p__20167){
var vec__20168 = p__20167;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20168,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20168,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__20168,x,y){
return (function (color,p__20171){
var vec__20172 = p__20171;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20172,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20172,(1),null);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__20172,x__$1,y__$1,mouseover_QMARK_,vec__20168,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__20172,x__$1,y__$1,mouseover_QMARK_,vec__20168,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__20172,x__$1,y__$1,mouseover_QMARK_,vec__20168,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__20172,x__$1,y__$1,mouseover_QMARK_,vec__20168,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__20172,x__$1,y__$1,mouseover_QMARK_,vec__20168,x,y){
return (function (){
var G__20175 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__20175) : re_frame.core.dispatch.call(null,G__20175));
});})(vec__20172,x__$1,y__$1,mouseover_QMARK_,vec__20168,x,y))
...
;})(mouseover_QMARK_,vec__20168,x,y))
});
mecca.notation.ledger_line = (function mecca$notation$ledger_line(p__20176){
...
mecca.notation.note = (function mecca$notation$note(value,p__20180){
var vec__20181 = p__20180;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20181,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20181,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__20181,x,y){
return (function (value__$1,p__20184){
var vec__20185 = p__20184;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20185,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20185,(1),null);
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__20185,x__$1,y__$1,mouseover_QMARK_,vec__20181,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__20185,x__$1,y__$1,mouseover_QMARK_,vec__20181,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__20185,x__$1,y__$1,mouseover_QMARK_,vec__20181,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__20185,x__$1,y__$1,mouseover_QMARK_,vec__20181,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__20185,x__$1,y__$1,mouseover_QMARK_,vec__20181,x,y){
return (function (){
var G__20188 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__20188) : re_frame.core.dispatch.call(null,G__20188));
});})(vec__20185,x__$1,y__$1,mouseover_QMARK_,vec__20181,x,y))
...
;})(mouseover_QMARK_,vec__20181,x,y))
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g_SHARP_lines,cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4324__auto__ = (function mecca$notation$staff_lines_$_iter__20189(s__20190){
return (new cljs.core.LazySeq(null,(function (){
var s__20190__$1 = s__20190;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__20190__$1);
if(temp__5457__auto__){
var s__20190__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20190__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__20190__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__20192 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__20191 = (0);
while(true){
if((i__20191 < size__4323__auto__)){
var y = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__20191);
cljs.core.chunk_append(b__20192,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,new cljs.core.PersistentArrayMap(null, 7, [cljs.core.cst$kw$x1,(7),cljs.core.cst$kw$x2,61.25,cljs.core.cst$kw$y1,((4) + y),cljs.core.cst$kw$y2,((4) + y),cljs.core.cst$kw$stroke,"black",cljs.core.cst$kw$stroke_DASH_width,0.15,cljs.core.cst$kw$visibility,"visible"], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)));

var G__20193 = (i__20191 + (1));
i__20191 = G__20193;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20192),mecca$notation$staff_lines_$_iter__20189(cljs.core.chunk_rest(s__20190__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20192),null);
}
} else {
var y = cljs.core.first(s__20190__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,new cljs.core.PersistentArrayMap(null, 7, [cljs.core.cst$kw$x1,(7),cljs.core.cst$kw$x2,61.25,cljs.core.cst$kw$y1,((4) + y),cljs.core.cst$kw$y2,((4) + y),cljs.core.cst$kw$stroke,"black",cljs.core.cst$kw$stroke_DASH_width,0.15,cljs.core.cst$kw$visibility,"visible"], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)),mecca$notation$staff_lines_$_iter__20189(cljs.core.rest(s__20190__$2)));
}
} else {
return null;
}
...
return iter__4324__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1((37)));
})())], null);
});
