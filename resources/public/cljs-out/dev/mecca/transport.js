...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$transform,["scale(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(scale),") translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y),")"].join('')], null)], 0))], null),(function (){var iter__4324__auto__ = (function mecca$transport$iter__18693(s__18694){
return (new cljs.core.LazySeq(null,(function (){
var s__18694__$1 = s__18694;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__18694__$1);
if(temp__5457__auto__){
var s__18694__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__18694__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__18694__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__18696 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__18695 = (0);
while(true){
if((i__18695 < size__4323__auto__)){
var vec__18697 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__18695);
...
cljs.core.chunk_append(b__18696,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$stroke,color,cljs.core.cst$kw$d,path], null)], null));

var G__18704 = (i__18695 + (1));
i__18695 = G__18704;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__18696),mecca$transport$iter__18693(cljs.core.chunk_rest(s__18694__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__18696),null);
}
} else {
var vec__18700 = cljs.core.first(s__18694__$2);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18700,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18700,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$stroke,color,cljs.core.cst$kw$d,path], null)], null),mecca$transport$iter__18693(cljs.core.rest(s__18694__$2)));
}
} else {
return null;
}
...
var G__18705 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$inc_DASH_tempo], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18705) : re_frame.core.dispatch.call(null,G__18705));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
mecca.transport.tempo_down = (function mecca$transport$tempo_down(x,y,scale){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$rect,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$y,cljs.core.cst$kw$stroke,cljs.core.cst$kw$width,cljs.core.cst$kw$on_DASH_click,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x,cljs.core.cst$kw$pointer_DASH_events,cljs.core.cst$kw$visibility,cljs.core.cst$kw$height],[y,"black",(scale * (12)),(function (){
var G__18706 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$dec_DASH_tempo], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18706) : re_frame.core.dispatch.call(null,G__18706));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
...
var G__18707_18709 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$stop], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18707_18709) : re_frame.core.dispatch.call(null,G__18707_18709));

return mecca.music.play_sample((17),(63));
})], null),(cljs.core.truth_(cljs.core.deref((function (){var G__18708 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$playing_QMARK_], null);
...
if(cljs.core.truth_(cljs.core.deref((function (){var G__18710 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$playing_QMARK_], null);
...
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
var G__18711_18713 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pause], null);
...
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
var G__18712_18714 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$play_DASH_on], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18712_18714) : re_frame.core.dispatch.call(null,G__18712_18714));
