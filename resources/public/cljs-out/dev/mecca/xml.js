...
return cljs.core.filter.call(null,(function (p1__21414_SHARP_){
return cljs.core._EQ_.call(null,tag,cljs.core.get.call(null,p1__21414_SHARP_,new cljs.core.Keyword(null,"tag","tag",-1290361223)));
...
return cljs.core.filter.call(null,(function (p1__21415_SHARP_){
return cljs.core._EQ_.call(null,voice,mecca.xml.get_voice.call(null,p1__21415_SHARP_));
...
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"time","time",1385887882),time,new cljs.core.Keyword(null,"pitch","pitch",1495126700),((mecca.xml.pitch__GT_midi.call(null,mecca.xml.get_pitch.call(null,note)) + (function (){var G__21416 = mecca.xml.get_voice.call(null,note);
switch (G__21416) {
case (5):
return (12);
...
})()) + (6)),new cljs.core.Keyword(null,"instrument","instrument",-960698844),(function (){var G__21417 = mecca.xml.get_voice.call(null,note);
switch (G__21417) {
case (5):
return (15);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21417)].join('')));
...
var G__21420 = (time + (mecca.xml.get_duration.call(null,cljs.core.first.call(null,notes)) / (6)));
var G__21421 = cljs.core.rest.call(null,notes);
var G__21422 = cljs.core.conj.call(null,result,mecca.xml.parse_note.call(null,cljs.core.first.call(null,notes),time));
time = G__21420;
notes = G__21421;
result = G__21422;
continue;
...
return mecca.xml.extract_voice.call(null,p1__21423_SHARP_,voice);
});})(time))
...
var G__21424 = (time + (mecca.xml.get_duration.call(null,cljs.core.first.call(null,notes)) / (6)));
var G__21425 = cljs.core.rest.call(null,notes);
var G__21426 = cljs.core.conj.call(null,result,mecca.xml.parse_note.call(null,cljs.core.first.call(null,notes),time));
time = G__21424;
notes = G__21425;
result = G__21426;
continue;
