...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23321){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23322,G__23323,seq23321__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23327_SHARP_){
return !((cljs.core.meta.call(null,p1__23327_SHARP_) == null));
})))){
...
var map__23328 = opts;
var map__23328__$1 = ((((!((map__23328 == null)))?(((((map__23328.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23328.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23328):map__23328);
var markup_db = cljs.core.get.call(null,map__23328__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23332){var _e__22087__auto__ = e23332;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e23334){var _e__22087__auto__ = e23334;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23336 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23337 = opts;
...
var markup_db = cljs.core.get.call(null,map__23337__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23336;
}});
...
;
var temp__5455__auto___23341 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___23341)){
var managed_print_level_23342 = temp__5455__auto___23341;
var _STAR_print_level_STAR_23340_23343 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23342;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23340_23343,managed_print_level_23342,temp__5455__auto___23341,writer,opts,job_fn){
return (function (p1__23339_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23339_SHARP_,null);
});})(_STAR_print_level_STAR_23340_23343,managed_print_level_23342,temp__5455__auto___23341,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23340_23343;
}} else {
job_fn.call(null);
}
