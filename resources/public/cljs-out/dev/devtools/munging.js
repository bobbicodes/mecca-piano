...
var o23150 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23150["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23151 = temp__5455__auto____$1;
return (o23151["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22080__auto__ = f;
return (o__22080__auto__["toString"]).call(o__22080__auto__);
} else {
return "";
}
}catch (e23152){var _ = e23152;
return "";
}});
...
try{var o__22080__auto___23154 = t;
(o__22080__auto___23154["cljs$lang$ctorPrWriter"]).call(o__22080__auto___23154,t,writer);
}catch (e23153){var __23155 = e23153;
}
...
var char_code = (function (){var o__22080__auto__ = (new String(char$));
return (o__22080__auto__["charCodeAt"]).call(o__22080__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22080__auto__ = String;
return (o__22080__auto__["fromCharCode"]).call(o__22080__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23156 = num_code;
switch (G__23156) {
case (1):
return (185);
...
var o__22080__auto__ = String;
return (o__22080__auto__["fromCharCode"]).call(o__22080__auto__,superscript_code);
});
/**
...
}catch (e23158){var _e__22087__auto__ = e23158;
return false;
}})())){
...
var vec__23159 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23159,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23162 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23162["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23163 = temp__5455__auto____$1;
return (o23163["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23166){
var vec__23167 = p__23166;
var ns_detector = cljs.core.nth.call(null,vec__23167,(0),null);
...
var G__23173 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23174 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23173;
remaining_tokens = G__23174;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23164){
var G__23165 = cljs.core.first.call(null,seq23164);
var seq23164__$1 = cljs.core.next.call(null,seq23164);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23165,seq23164__$1);
});
...
var vec__23178 = cljs.core.split_with.call(null,(function (p1__23177_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23177_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23178,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23178,(1),null);
...
var vec__23181 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23181,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23181,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23184 = cljs.core.rest.call(null,remaining_tokens);
var G__23185 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23184;
name_tokens = G__23185;
continue;
} else {
...
var vec__23188 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23188,(0),null);
var arity = cljs.core.nth.call(null,vec__23188,(1),null);
var vec__23191 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23191,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23191,(1),null);
var vec__23194 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23194,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23194,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23194,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23194,(3),null);
...
var vec__23200 = result;
var munged_ns = cljs.core.nth.call(null,vec__23200,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23200,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23200,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23200,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23200,(4),null);
var arity = cljs.core.nth.call(null,vec__23200,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23204 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23204,(0),null);
var args = cljs.core.nth.call(null,vec__23204,(1),null);
var vec__23207 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__23210 = (arity + (1));
var G__23211 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23212){
var vec__23213 = p__23212;
var arity = cljs.core.nth.call(null,vec__23213,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23213,(1),null);
...
return cljs.core.get.call(null,arities,p1__23216_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23217_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23220){
var vec__23221 = p__23220;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23221,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23218){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23229__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23229__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23229__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23229__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23230 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23230,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23230,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23230,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23230,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23230,(4),null);
var arity = cljs.core.nth.call(null,vec__23230,(5),null);
...
var o__22080__auto__ = f;
return (o__22080__auto__["getBasis"]).call(o__22080__auto__);
});
/**
...
}catch (e23234){var _e__22087__auto__ = e23234;
...
var G__23235 = (obj[cljs.core.first.call(null,path)]);
var G__23236 = cljs.core.rest.call(null,path);
obj = G__23235;
path = G__23236;
continue;
} else {
...
return (function (accum,p__23237){
var vec__23238 = p__23237;
var bit = cljs.core.nth.call(null,vec__23238,(0),null);
var protocol = cljs.core.nth.call(null,vec__23238,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23241){
var vec__23242 = p__23241;
var ns = cljs.core.nth.call(null,vec__23242,(0),null);
var name = cljs.core.nth.call(null,vec__23242,(1),null);
var selector = cljs.core.nth.call(null,vec__23242,(2),null);
...
return (function (p__23246){
var vec__23247 = p__23246;
var munged_name = cljs.core.nth.call(null,vec__23247,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23247,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23247,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23245_SHARP_){
return (obj[cljs.core.first.call(null,p1__23245_SHARP_)]);
});})(name,sorted_matches,vec__23247,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
