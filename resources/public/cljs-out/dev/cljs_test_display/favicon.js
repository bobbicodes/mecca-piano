...
return cljs.core.map.call(null,(function (p1__21930_SHARP_){
return html_coll.item(p1__21930_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__21931_SHARP_);
...
var ctx_21932 = cvs.getContext("2d");
ctx_21932.fillStyle = color;

ctx_21932.fillRect((0),(0),size,size);
