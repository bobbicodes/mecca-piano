...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k18719,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k18719,else__4206__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18718){
var self__ = this;
var G__18718__$1 = this;
return (new cljs.core.RecordIter((0),G__18718__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$status,cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4061__auto____$1 = (function (){var fexpr__18724 = ((function (h__4061__auto__,this__4199__auto____$1){
return (function (coll__4200__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4200__auto__));
});})(h__4061__auto__,this__4199__auto____$1))
;
return fexpr__18724(this__4199__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this18720,other18721){
var self__ = this;
var this18720__$1 = this;
return ((!((other18721 == null))) && ((this18720__$1.constructor === other18721.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18720__$1.status,other18721.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18720__$1.body,other18721.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18720__$1.status_text,other18721.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18720__$1.headers,other18721.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18720__$1.was_aborted,other18721.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18720__$1.__extmap,other18721.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__18718){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__18725 = cljs.core.keyword_identical_QMARK_;
var expr__18726 = k__4211__auto__;
if(cljs.core.truth_((function (){var G__18728 = cljs.core.cst$kw$status;
var G__18729 = expr__18726;
return (pred__18725.cljs$core$IFn$_invoke$arity$2 ? pred__18725.cljs$core$IFn$_invoke$arity$2(G__18728,G__18729) : pred__18725.call(null,G__18728,G__18729));
})())){
return (new ajax.protocols.Response(G__18718,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18730 = cljs.core.cst$kw$body;
var G__18731 = expr__18726;
return (pred__18725.cljs$core$IFn$_invoke$arity$2 ? pred__18725.cljs$core$IFn$_invoke$arity$2(G__18730,G__18731) : pred__18725.call(null,G__18730,G__18731));
})())){
return (new ajax.protocols.Response(self__.status,G__18718,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18732 = cljs.core.cst$kw$status_DASH_text;
var G__18733 = expr__18726;
return (pred__18725.cljs$core$IFn$_invoke$arity$2 ? pred__18725.cljs$core$IFn$_invoke$arity$2(G__18732,G__18733) : pred__18725.call(null,G__18732,G__18733));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__18718,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18734 = cljs.core.cst$kw$headers;
var G__18735 = expr__18726;
return (pred__18725.cljs$core$IFn$_invoke$arity$2 ? pred__18725.cljs$core$IFn$_invoke$arity$2(G__18734,G__18735) : pred__18725.call(null,G__18734,G__18735));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__18718,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18736 = cljs.core.cst$kw$was_DASH_aborted;
var G__18737 = expr__18726;
return (pred__18725.cljs$core$IFn$_invoke$arity$2 ? pred__18725.cljs$core$IFn$_invoke$arity$2(G__18736,G__18737) : pred__18725.call(null,G__18736,G__18737));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__18718,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4211__auto__,G__18718),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__18718){
var self__ = this;
var this__4202__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__18718,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__18722){
var extmap__4236__auto__ = (function (){var G__18738 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__18722,cljs.core.cst$kw$status,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], 0));
if(cljs.core.record_QMARK_(G__18722)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__18738);
} else {
return G__18738;
}
})();
return (new ajax.protocols.Response(cljs.core.cst$kw$status.cljs$core$IFn$_invoke$arity$1(G__18722),cljs.core.cst$kw$body.cljs$core$IFn$_invoke$arity$1(G__18722),cljs.core.cst$kw$status_DASH_text.cljs$core$IFn$_invoke$arity$1(G__18722),cljs.core.cst$kw$headers.cljs$core$IFn$_invoke$arity$1(G__18722),cljs.core.cst$kw$was_DASH_aborted.cljs$core$IFn$_invoke$arity$1(G__18722),null,cljs.core.not_empty(extmap__4236__auto__),null));
});
