...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__19197){
...
var fexpr__19202 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__19202.cljs$core$IFn$_invoke$arity$1 ? fexpr__19202.cljs$core$IFn$_invoke$arity$1(response) : fexpr__19202.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__19203 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__19203.cljs$core$IFn$_invoke$arity$1 ? fexpr__19203.cljs$core$IFn$_invoke$arity$1(response) : fexpr__19203.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__19205){
...
var request = map__19206__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19206__$1,cljs.core.cst$kw$response_DASH_format);
