...
var G__19409 = format;
var G__19409__$1 = (((G__19409 instanceof cljs.core.Keyword))?G__19409.fqn:null);
switch (G__19409__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__19411 = cljs.core.second(format);
var G__19412 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__19411,G__19412) : ajax.easy.keyword_response_format_element.call(null,G__19411,G__19412));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19415_SHARP_){
return ajax.easy.keyword_response_format_element(p1__19415_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__19416){
var map__19417 = p__19416;
var map__19417__$1 = ((((!((map__19417 == null)))?(((((map__19417.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19417.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19417):map__19417);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19417__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19417__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19417__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__19417,map__19417__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__19419){
var vec__19420 = p__19419;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19420,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19420,(1),null);
var fexpr__19423_19424 = (cljs.core.truth_(ok)?h:e);
(fexpr__19423_19424.cljs$core$IFn$_invoke$arity$1 ? fexpr__19423_19424.cljs$core$IFn$_invoke$arity$1(result) : fexpr__19423_19424.call(null,result));
...
;})(h,e,map__19417,map__19417__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__19425){
var map__19426 = p__19425;
var map__19426__$1 = ((((!((map__19426 == null)))?(((((map__19426.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19426.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19426):map__19426);
var opts = map__19426__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19426__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19426__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19426__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19426__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19426__$1,cljs.core.cst$kw$body);
