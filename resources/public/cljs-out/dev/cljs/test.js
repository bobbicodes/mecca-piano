...
var G__21095 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__21095,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21095;
}
});
...
var len__4531__auto___21100 = arguments.length;
var i__4532__auto___21101 = (0);
while(true){
if((i__4532__auto___21101 < len__4531__auto___21100)){
args__4534__auto__.push((arguments[i__4532__auto___21101]));

var G__21102 = (i__4532__auto___21101 + (1));
i__4532__auto___21101 = G__21102;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21097){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21098,G__21099,seq21097__$2);
});
...
var column = cljs.core.get.call(null,map__21104__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__21104,map__21104__$1,file,line,column){
return (function (p1__21103_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21103_SHARP_));
});})(map__21104,map__21104__$1,file,line,column))
...
var temp__5457__auto___21108 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21108)){
var message_21109 = temp__5457__auto___21108;
cljs.core.println.call(null,message_21109);
} else {
}
...
var output_dir__$1 = (function (){var G__21110 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21110),"/"].join('');
} else {
return G__21110;
}
})();
...
var G__21112 = exception.stack;
var G__21112__$1 = (((G__21112 == null))?null:clojure.string.split_lines.call(null,G__21112));
var G__21112__$2 = (((G__21112__$1 == null))?null:cljs.core.get.call(null,G__21112__$1,depth));
if((G__21112__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21112__$2);
}
} else {
...
var vec__21113 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21113,(0),null);
var column = cljs.core.nth.call(null,vec__21113,(1),null);
var vec__21116 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21116,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21116,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21116,(2),null);
...
var m__$1 = (function (){var G__21119 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__21123 = (function (){var G__21122 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21122);
} else {
return G__21122;
}
})();
...
return cljs.core.vary_meta.call(null,G__21124,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__21128 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21128,(0),null);
var types = vec__21128;
...
return cljs.core.map.call(null,(function (p__21131){
var vec__21132 = p__21131;
var ns = cljs.core.nth.call(null,vec__21132,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21132,(1),null);
return ((function (vec__21132,ns,vars__$1){
return (function (){
...
var G__21135 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__21135,G__21135__$1,env,once_fixtures,each_fixtures,vec__21132,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__21135,G__21135__$1,env,once_fixtures,each_fixtures,vec__21132,ns,vars__$1){
return (function (){
var seq__21136 = cljs.core.seq.call(null,vars__$1);
var chunk__21137 = null;
var count__21138 = (0);
var i__21139 = (0);
while(true){
if((i__21139 < count__21138)){
var v = cljs.core._nth.call(null,chunk__21137,i__21139);
var temp__5457__auto___21141 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21141)){
var t_21142 = temp__5457__auto___21141;
each_fixture_fn.call(null,((function (seq__21136,chunk__21137,count__21138,i__21139,t_21142,temp__5457__auto___21141,v,each_fixture_fn,G__21135,G__21135__$1,env,once_fixtures,each_fixtures,vec__21132,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21142)));
});})(seq__21136,chunk__21137,count__21138,i__21139,t_21142,temp__5457__auto___21141,v,each_fixture_fn,G__21135,G__21135__$1,env,once_fixtures,each_fixtures,vec__21132,ns,vars__$1))
);
} else {
}


var G__21143 = seq__21136;
var G__21144 = chunk__21137;
var G__21145 = count__21138;
var G__21146 = (i__21139 + (1));
seq__21136 = G__21143;
chunk__21137 = G__21144;
count__21138 = G__21145;
i__21139 = G__21146;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__21136);
if(temp__5457__auto__){
var seq__21136__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21136__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__21136__$1);
var G__21147 = cljs.core.chunk_rest.call(null,seq__21136__$1);
var G__21148 = c__4351__auto__;
var G__21149 = cljs.core.count.call(null,c__4351__auto__);
var G__21150 = (0);
seq__21136 = G__21147;
chunk__21137 = G__21148;
count__21138 = G__21149;
i__21139 = G__21150;
continue;
} else {
var v = cljs.core.first.call(null,seq__21136__$1);
var temp__5457__auto___21151__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21151__$1)){
var t_21152 = temp__5457__auto___21151__$1;
each_fixture_fn.call(null,((function (seq__21136,chunk__21137,count__21138,i__21139,t_21152,temp__5457__auto___21151__$1,v,seq__21136__$1,temp__5457__auto__,each_fixture_fn,G__21135,G__21135__$1,env,once_fixtures,each_fixtures,vec__21132,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21152)));
});})(seq__21136,chunk__21137,count__21138,i__21139,t_21152,temp__5457__auto___21151__$1,v,seq__21136__$1,temp__5457__auto__,each_fixture_fn,G__21135,G__21135__$1,env,once_fixtures,each_fixtures,vec__21132,ns,vars__$1))
);
} else {
}


var G__21153 = cljs.core.next.call(null,seq__21136__$1);
var G__21154 = null;
var G__21155 = (0);
var G__21156 = (0);
seq__21136 = G__21153;
chunk__21137 = G__21154;
count__21138 = G__21155;
i__21139 = G__21156;
continue;
}
} else {
...
});})(each_fixture_fn,G__21135,G__21135__$1,env,once_fixtures,each_fixtures,vec__21132,ns,vars__$1))
);
});})(each_fixture_fn,G__21135,G__21135__$1,env,once_fixtures,each_fixtures,vec__21132,ns,vars__$1))
], null);
