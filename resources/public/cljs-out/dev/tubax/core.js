...
tubax.core.xml__GT_clj.cljs$core$IFn$_invoke$arity$2 = (function (source,p__21406){
...
var strict = cljs.core.get.call(null,map__21407__$1,new cljs.core.Keyword(null,"strict","strict",-665564191),true);
var trim = cljs.core.get.call(null,map__21407__$1,new cljs.core.Keyword(null,"trim","trim",774319767),true);
var normalize = cljs.core.get.call(null,map__21407__$1,new cljs.core.Keyword(null,"normalize","normalize",-1904390051),false);
var lowercase = cljs.core.get.call(null,map__21407__$1,new cljs.core.Keyword(null,"lowercase","lowercase",41029539),true);
var xmlns = cljs.core.get.call(null,map__21407__$1,new cljs.core.Keyword(null,"xmlns","xmlns",-1862095571));
var position = cljs.core.get.call(null,map__21407__$1,new cljs.core.Keyword(null,"position","position",-2011731912),true);
var strict_entities = cljs.core.get.call(null,map__21407__$1,new cljs.core.Keyword(null,"strict-entities","strict-entities",-551773933),false);
...
parser.onopentag = ((function (parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__21399_SHARP_){
return cljs.core.swap_BANG_.call(null,document,cljs.core.partial.call(null,tubax.core.add_node_document,p1__21399_SHARP_));
});})(parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onclosetag = ((function (parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__21400_SHARP_){
return cljs.core.swap_BANG_.call(null,document,cljs.core.partial.call(null,tubax.core.close_node_document,p1__21400_SHARP_));
});})(parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.ontext = ((function (parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__21401_SHARP_){
return cljs.core.swap_BANG_.call(null,document,cljs.core.partial.call(null,tubax.core.add_text,p1__21401_SHARP_));
});})(parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.oncdata = ((function (parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__21402_SHARP_){
return cljs.core.swap_BANG_.call(null,document,cljs.core.partial.call(null,tubax.core.add_text,p1__21402_SHARP_));
});})(parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onend = ((function (parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (){
...
parser.onerror = ((function (parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__21403_SHARP_){
return cljs.core.reset_BANG_.call(null,result,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__21403_SHARP_)].join('')], null));
});})(parser,document,result,map__21407,map__21407__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;
